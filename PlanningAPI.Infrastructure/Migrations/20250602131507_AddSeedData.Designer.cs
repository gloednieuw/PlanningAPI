...
namespace PlanningAPI.Infrastructure.Migrations
{
    ...
    [Migration("20250602131507_AddSeedData")]
            ...
            modelBuilder.Entity("PlanningAPI.Model.Line", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LineId = 1,
                            LinePlanningNumber = "Bus 24",
                            OperatorNo = 1
                        },
                        new
                        {
                            LineId = 2,
                            LinePlanningNumber = "Tram 12",
                            OperatorNo = 1
                        });
                });
            ...
            modelBuilder.Entity("PlanningAPI.Model.Operator", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OperatorId = 1,
                            ApiEndpoint = "api.htm.net",
                            Name = "HTM"
                        },
                        new
                        {
                            OperatorId = 2,
                            ApiEndpoint = "api.arriva.nl",
                            Name = "Arriva"
                        });
                });
            ...
            modelBuilder.Entity("PlanningAPI.Model.Trip", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TripId = 1,
                            ArrivalTime = new DateTime(2025, 6, 2, 15, 45, 7, 360, DateTimeKind.Local).AddTicks(8067),
                            DepartureTime = new DateTime(2025, 6, 2, 14, 15, 7, 360, DateTimeKind.Local).AddTicks(8011),
                            LineNo = 2
                        },
                        new
                        {
                            TripId = 2,
                            ArrivalTime = new DateTime(2025, 6, 2, 16, 0, 7, 360, DateTimeKind.Local).AddTicks(8073),
                            DepartureTime = new DateTime(2025, 6, 2, 15, 30, 7, 360, DateTimeKind.Local).AddTicks(8071),
                            LineNo = 2
                        });
                });
